...
<div class="row g-3">
  <div class="col-md-6">
      ...
      <input type="text" class="form-control"  name="user_branchName" value="<?php echo $branchName ?>" required>
  </div>
  <div class="col-md-6">
...
<div class="row g-3">
  <div class="col-md-6">
      ...
      <input type="text" class="form-control" name="user_projectName" value="<?php echo $projectName ?>" required>
  </div>
