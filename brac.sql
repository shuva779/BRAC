...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 24, 2022 at 08:44 PM
...
CREATE TABLE `user` (
  ...
  `user_branchName` varchar(200) DEFAULT NULL,
  `user_region` varchar(25) NOT NULL,
  `user_rm` varchar(20) DEFAULT NULL,
  `user_dm` varchar(20) DEFAULT NULL,
  `user_am` varchar(20) DEFAULT NULL,
  `user_projectName` varchar(200) DEFAULT NULL,
...
INSERT INTO `user` (`user_id`, `user_fullName`, `user_userName`, `user_email`, `user_gender`, `user_dob`, `user_qualification`, `user_phone`, `user_password`, `user_div`, `user_dis`, `user_upa`, `user_fullAddress`, `user_workexp`, `user_pin`, `user_designation`, `user_empType`, `user_joinDate`, `user_branchName`, `user_region`, `user_rm`, `user_dm`, `user_am`, `user_projectName`, `user_pdiv`, `user_pdis`, `user_pupa`) VALUES
(53, 'Shuva Chowdhury', 'shuva123', 'shu@gmail.com', 'Male', '1997-09-19 18:00:00', 'BS in CSE', '01911188183', 'shuva123', 'Rajshahi', 'Bogura', 'Bogra Sadar', '89/D, Bashabo', 'intern at brac', '12345', 'Intern ship', 'Good', '2022-07-24 18:00:00', 'Savar Banasree', 'Dhaka', 'x', 'y', 'z', 'STAR SCF', 'Chattagram', 'Coxsbazar', 'Bogra Sadar'),
(54, 'Rabi', 'rabi', 'rabi@gmail.com', 'Female', '2022-08-03 18:00:00', 'BS in Echo', '01982098765', '1234', 'Chattagram', 'Chandpur', 'Matlab South', '90/j, abc', 'intern', '1234', 'Intern ship', 'a+', '2022-08-15 18:00:00', 'Savar Mirpur (Pollobi) Jatrabari ', 'Dhaka2', 'csc', 'sc', 'z', 'STAR DID', 'Chattagram', 'Coxsbazar', 'Matlab South');
...
--
ALTER TABLE `user`
  MODIFY `user_id` bigint(25) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
