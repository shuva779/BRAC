<?php
  require 'connections.php';
      ...
      $sql="INSERT INTO user(`user_fullName`,`user_userName`,`user_email`,`user_gender`,`user_dob`,`user_qualification`,`user_phone`,`user_password`,`user_div`,`user_dis`,`user_upa`,`user_fullAddress`,`user_workexp`,`user_pin`,`user_designation`,`user_empType`,`user_joinDate`,`user_branchName`,`user_region`,`user_rm`,`user_dm`,`user_am`,`user_projectName`,`user_pdiv`,`user_pdis`,`user_pupa`)
      values('$user_fullName','$user_userName','$user_email','$user_gender','$user_dob','$user_qualification','$user_phone','$user_password','$user_div','$user_dis','$user_upa','$user_fullAddress','$user_workexp','$user_pin','$user_designation','$user_empType','$user_joinDate','$user_branchName','$user_region','$user_rm','$user_dm','$user_am','$user_projectName','$user_pdiv','$user_pdis','$user_pupa')";
